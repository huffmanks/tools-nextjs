...
const EmailOutput = ({ values, themeValues }) => {
        ...
        <>
            <Box
                ...
                <div style={{ fontFamily: '"Montserrat", sans-serif' }} ref={resultRef}>
                    <div style={{ color: getColorCode(themeValues), fontWeight: 'bold', fontSize: '20px', fontFamily: '"Montserrat", sans-serif' }}>{values.fullName}</div>
                    ...
                    <div style={{ marginBottom: '16px' }}>
                        <div>
                            ...
                            <a href={`mailto:${values.email}`} style={{ color: getColorCode(themeValues), fontSize: '14px', textDecoration: 'none', fontFamily: '"Montserrat", sans-serif' }}>
                                {values.email}
                            </a>
                        </div>
                        ...
                        {values.website && (
                            <div>
                                ...
                                <a href={values.website} style={{ color: getColorCode(themeValues), fontSize: '14px', textDecoration: 'none', fontFamily: '"Montserrat", sans-serif' }}>
                                    {values.website}
                                </a>
                            </div>
                        )}
                    ...
                    <div style={{ color: getColorCode(themeValues), fontSize: '14px', fontFamily: '"Montserrat", sans-serif' }}>{values.companyName} </div>
                    <div style={{ color: getColorCode(themeValues), fontSize: '14px', fontFamily: '"Montserrat", sans-serif' }}> {values.department}</div>
                    <div style={{ color: getColorCode(themeValues), fontSize: '14px', fontFamily: '"Montserrat", sans-serif' }}>
                ...
                <IconButton
                    sx={{
                        ...
                        '&:hover': {
                            backgroundColor: getColorCode(themeValues),
                            '& svg': {
                                color: '#fff',
                            },
                        },
                        '& svg': {
                            color: getColorCode(themeValues),
                        },
                    }}
